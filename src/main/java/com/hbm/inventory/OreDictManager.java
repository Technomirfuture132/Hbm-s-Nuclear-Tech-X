...
public class OreDictManager {
	...
	public static final DictFrame CMF = new DictFrame("CuriumFuel","CmF");
	public static final DictFrame CMRG = new DictFrame("CuriumRG");
	public static final DictFrame CM = new DictFrame("Curium", "Cm");
	...
	public static final DictFrame BK248 = new DictFrame("Berkelium248","Bk248");
	public static final DictFrame BK249 = new DictFrame("Berkelium249","Bk249");
	public static final DictFrame CF249 = new DictFrame("Californium249","Cf249");
	public static final DictFrame CF250 = new DictFrame("Californium250","Cf250");
	...
	public static void registerOres() {
		...
		CMRG    .rad(HazardRegistry.cmrg)	.hot(4F)				.nugget(nugget_cm_mix)		.billet(billet_cm_mix)		.ingot(ingot_cm_mix);
		CMF     .rad(HazardRegistry.cmf)	.hot(2F)				.nugget(nugget_cm_fuel)		.billet(billet_cm_fuel)		.ingot(ingot_cm_fuel);
		CM      .rad(HazardRegistry.cm)		.hot(3F)				.nugget(nugget_curium)		.billet(billet_curium)		.ingot(ingot_curium)       .dust(powder_curium) .dustSmall(powder_curium_tiny);
		CM242	.rad(HazardRegistry.cm242)	.hot(6F)				.nugget(nugget_cm242)		.billet(billet_cm242)		.ingot(ingot_cm242);
		...
		CF249	.rad(HazardRegistry.cf249)	.hot(6F)				.nugget(nugget_cf249)		.billet(billet_cf249)		.ingot(ingot_cf249)        .nuggetSmall(nugget_cf249_tiny); //californium is so hot that it forms a molten microscopic droplet
		CF250	.rad(HazardRegistry.cf250)	.hot(3F)				.nugget(nugget_cf250)		.billet(billet_cf250)		.ingot(ingot_cf250)        .nuggetSmall(nugget_cf250_tiny);
		CF251	.rad(HazardRegistry.cf251)	.hot(2F)				.nugget(nugget_cf251)		.billet(billet_cf251)		.ingot(ingot_cf251)        .nuggetSmall(nugget_cf251_tiny);
		CF252	.rad(HazardRegistry.cf252)	.hot(8F)				.nugget(nugget_cf252)		.billet(billet_cf252)		.ingot(ingot_cf252)        .nuggetSmall(nugget_cf252_tiny);
	...
	public static class DictFrame {
		...
		public DictFrame nuggetSmall(Object... nuggetSmall) {
			hazMult = HazardRegistry.nugget_tiny;
			return makeObject(NUGGETTINY, nuggetSmall);
		}
