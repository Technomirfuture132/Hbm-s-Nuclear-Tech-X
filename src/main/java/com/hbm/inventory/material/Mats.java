...
public class Mats {
	...
	public static final NTMMaterial MAT_AM243		= makeSmeltable(9543,		AM243,		0xCEB3B9, 0x3A1C21, 0x93767B).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_CURIUM		= makeSmeltable(9600,		CM,		    0x927178, 0x633C43, 0XEAD7DC).setAutogen(NUGGET, BILLET, DUST, INGOT).m();
	public static final NTMMaterial MAT_RGC		    = makeSmeltable(9601,		CMRG,		0x927178, 0x633C43, 0XEAD7DC).setAutogen(NUGGET, BILLET, INGOT).m();
	public static final NTMMaterial MAT_CM242		= makeSmeltable(9642,		CM242,		0x927178, 0x633C43, 0XEAD7DC).setAutogen(NUGGET, BILLET, INGOT).m();
	public static final NTMMaterial MAT_CM243		= makeSmeltable(9643,		CM243,		0x927178, 0x633C43, 0XEAD7DC).setAutogen(NUGGET, BILLET, INGOT).m();
	public static final NTMMaterial MAT_CM244		= makeSmeltable(9644,		CM244,		0x927178, 0x633C43, 0XEAD7DC).setAutogen(NUGGET, BILLET, INGOT).m();
	...
	public static final NTMMaterial MAT_CF252		= makeSmeltable(9852,		CF252,		0xFFC5A2, 0xFF9D60, 0xFFDBC9).setAutogen(NUGGET, BILLET, INGOT).m();
