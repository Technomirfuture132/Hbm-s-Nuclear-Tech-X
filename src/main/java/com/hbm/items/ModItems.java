...
public class ModItems {
	...
	public static Item billet_zfb_cm_mix; 
	...
	public static void initializeItem() {
		...
		billet_zfb_cm_mix = new Item().setUnlocalizedName("billet_zfb_cm_mix").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":billet_zfb_cm_mix");
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(billet_zfb_cm_mix, billet_zfb_cm_mix.getUnlocalizedName());
		...
		GameRegistry.registerItem(rbmk_pellet_zfb_cm_mix, rbmk_pellet_zfb_cm_mix.getUnlocalizedName());
