...
public class ItemWatzPellet extends ItemEnumMulti {
	...
	public static enum EnumWatzType {
		...
		LEA(            0xC7BDBB, 0x322724, 0,	    10D,	0.00025D,	new FunctionSqrt(120), new FunctionSqrtFalling(15D), null),
		MEA(            0xCEB3B9, 0x3A1C21, 0,       15D,    0.0035D,    new FunctionSqrt(170), new FunctionSqrtFalling(10D), null),    
		HEA(            0xCEB3B9, 0x3A1C21, 0,       20D,    0.00145D,   new FunctionSqrt(200), new FunctionSqrtFalling(10D), null),    
		LEC(            0xE6DFDD, 0x594B47, 0,       15D,    0.00155D,   new FunctionSqrt(110), new FunctionSqrtFalling(10D), null),   
		MEC(            0xE6DFDD, 0x594B47, 0,       20D,    0.00166D,   new FunctionSqrt(210), new FunctionSqrtFalling(15D), null),
		HEC(            0xEAE0E2, 0x634F53, 0,       25D,    0.00240D,   new FunctionSqrt(220), new FunctionSqrtFalling(15D), null),
