...
public class HazardRegistry {
	...
	//AM243		          7370a		α	004.50Rad/s
	//Cm242                163d     α   065.50Rad/s Spicy  Curium is more radioactive than americium    
	//Cm243                 29a     α   030.50Rad/s Spicy  It can be used in a mixture with a powerful source of alpha radiation, such as curium-242
	//Cm244                 18a     α   035.50Rad/s Spicy  It is good as nuclear fuel, but still slightly worse than curium-245
	//Cm245              8,500a     α   015.50Rad/s Spicy  Long-lived isotope of curium, suitable for nuclear reactors, high neutron cross section
	//Bk247              1,385a     α   021.00Rad/s Spicy
	//Bk248                300a     α   071.00Rad/s Spicy
	//Bk249                330d     β−  120.00Rad/s  2 much spice :( Decays to form californium-249
	//Cf249                351d     α   1200.00Rad/s 2 much spice :(
	//Cf250               13.8a     α   0630.00Rad/s 2 much spice :(
	//Cf251                900a     α   0480.00Rad/s 2 much spice :(
	//Cf252                2.6a     α   2600.00Rad/s 2 much spice :(  Californium-252 is a very powerful neutron source
	...
	public static final float am243 = 6.05F;
	public static final float amrg = 8.5F;
	public static final float amf = 4.75F;
	public static final float cm = 30.0F;
	public static final float cmf = 11.5F;
	...
	public static final float nugget_tiny = nugget * 0.1F;
	...
	public static void registerItems() {
		...
		registerRTGPellet(pellet_rtg_curium, cm242 * rtg, 0, 3F);
		...
		registerRBMKPellet(rbmk_pellet_hec247, cm247 * billet, wst * billet * 25.5F);
